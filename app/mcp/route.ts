...
// Set to 800 if you have a Vercel Pro or Enterprise account with Fluid compute enabled
 ...
 * MCP Handler
 * 
 * This handler supports both HTTP POST (stdio-like) and SSE transports.
 * For SSE on Vercel, Redis is required under process.env.REDIS_URL
